...
class ChangeInformation1Cest
{
    public function tryToTest(AcceptanceTester $I)
    {
        $I->amOnPage('/login.php');
        $I->fillField(['id' => 'id_email'], 'vshbmt@gmail.com');//success with correct format input
        ...
        $I->assertEquals('Change information success', $status);
        $I->wait(1);
    }
}
