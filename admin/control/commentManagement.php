...
<table style="width: 100%; margin: 5px;">
    ...
    while ($count < $sumcount){
        ...
        if($count%2 == 0) echo '#e9ffff'; else echo "#fff";
        echo '">
                <td>'.$count.'</td>
             ...
             <button onClick="deleteitemn(this.id, this.name)"  name="'.$getlist[$count][0].'" class="btn btn-danger"  id="'.$getlist[$count][1].'">Xóa</button>
...
<dialog id="xacnhanxoa" style="border: none; width: 500px;  box-shadow: 0px 0px 5px 5px #666; border-radius: 5px">
    ...
    <form style="float: right">
        ...
        <input id = "classify" name="classify" value="" style="display: none">
        <button style="padding: 5px;" class="btn btn-primary" id="xacnhandelete">Xác nhận</button>
    </form>
</dialog>
<script>function deleteitemn(clicked_id, clicked_name)
    {
